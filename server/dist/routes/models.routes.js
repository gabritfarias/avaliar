...
router.get('/:id', async (req, res) => {
    try {
        ...
        const model = await prisma_1.prisma.model.findUnique({
            where: { id },
            include: {
...
router.post('/', async (req, res) => {
    try {
        ...
        const existing = await prisma_1.prisma.model.findFirst({
            where: {
                name: {
                    equals: trimmedName,
                    mode: 'insensitive',
        ...
        const count = await prisma_1.prisma.model.count();
        ...
        const defaultParts = createDefaultParts
            ...
            : [];
        const newModel = await prisma_1.prisma.model.create({
            data: {
                name: trimmedName,
...
router.post('/:id/variants', async (req, res) => {
    try {
        ...
        const variant = await prisma_1.prisma.variant.create({
            data: {
                modelId,
...
router.put('/variants/:id', async (req, res) => {
    try {
        ...
        const updated = await prisma_1.prisma.variant.update({
            where: { id },
            data,
        });
        res.json(updated);
...
router.delete('/variants/:id', async (req, res) => {
    try {
        const id = Number(req.params.id);
        await prisma_1.prisma.variant.delete({
            where: { id },
        });
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        await prisma_1.prisma.model.delete({
            where: { id },
        });
        res.json({
